...
impl ContentType {
    ...
    pub fn description(&self) -> &'static str {
        match self {
            ...
            ContentType::Xml => "XML",
            ContentType::Docx => "Word document (DOCX)",
            ContentType::Xlsx => "Excel spreadsheet (XLSX)",
            ContentType::Csv => "CSV spreadsheet",
            ContentType::Odt => "OpenDocument text (ODT)",
            ContentType::Ods => "OpenDocument spreadsheet (ODS)",
            ContentType::Epub => "EPUB e-book",
            ContentType::Pptx => "PowerPoint presentation (PPTX)",
...
pub fn detect_from_extension(filename: &str) -> ContentType {
    ...
    match ext.as_deref() {
        ...
        Some("odt") => ContentType::Odt,
        Some("ods") => ContentType::Ods,
        Some("epub") => ContentType::Epub,
