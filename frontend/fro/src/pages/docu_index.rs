    ...
    rsx! {
        ...
        if show_embeddings_modal() {
            div {
                ...
                div {
                    class: "p-6 max-w-4xl mx-auto pb-20",
                    ...
                    p { class: "text-sm text-gray-300 mb-2", "This expression captures several important ideas:" }
                    ul { class: "space-y-2 text-sm text-gray-300 ml-4 list-disc",
                        li { "The symbol " strong { "∈" } " means \"is an element of\" or \"belongs to.\"" }
                        li { strong { "ℝ" } " is the set of all real numbers." }
                        li { strong { "ℝⁿ" } " is the set of all n-dimensional vectors of real numbers." }
                    }
                    p { class: "text-sm text-gray-300 mt-4 mb-2",
                        "So the statement " strong { "v ∈ ℝⁿ" } " means:"
                    }
                    ...
                    p { class: "text-sm text-gray-300 mb-4", "Because embeddings live in a structured vector space:" }
                    ul { class: "space-y-3 text-sm text-gray-300 ml-4",
                        li {
                            strong { "Distances" } " reflect similarity (closer vectors → more similar meanings)"
                        }
                        li {
                            strong { "Directions" } " encode relationships (e.g., the famous analogy: king - man + woman ≈ queen)"
                        }
                        li { strong { "Clustering" } " groups related concepts" }
                        li { strong { "Search" } " becomes geometric nearest-neighbor lookup" }
                        li { strong { "Classification" } " becomes linear separation in high-dimensional space" }
                    }
                    ...
                    h3 { class: "text-xl font-bold text-white mt-8 mb-3", "How ONNX and Neo4j Relate Through Embeddings" }

                    // 1. ONNX
                    h4 { class: "text-lg font-semibold text-white mt-6 mb-2", "1. ONNX: The Model Runtime That Produces Embeddings" }
                    p { class: "text-sm text-gray-300 mb-2",
                    ...
                    p { class: "text-sm text-gray-300 mt-2",
                        "This vector is your semantic representation. So " strong { "ONNX is the embedding generator" } "."
                    }

                    // 2. Neo4j
                    h4 { class: "text-lg font-semibold text-white mt-6 mb-2", "2. Neo4j: The Graph Database That Stores and Queries Embeddings" }
                    p { class: "text-sm text-gray-300 mb-2",
                    ...
                    p { class: "text-sm text-gray-300 mt-2 mb-2", "This means you can store embeddings directly on nodes:" }
                    ...
                    p { class: "text-sm text-gray-300 mt-2 mb-2", "And then run vector similarity queries:" }
                    div { class: "bg-gray-700 rounded p-3 my-2 font-mono text-xs text-green-300",
                        "MATCH (d:Document)"
                        br {}
                    ...
                    p { class: "text-sm text-gray-300 mt-2",
                        "So " strong { "Neo4j is the embedding store + search engine + relationship engine" } "."
                    }

                    // 3. How They Work Together
                    h4 { class: "text-lg font-semibold text-white mt-6 mb-2", "3. How They Work Together" }
                    div { class: "space-y-3 text-sm text-gray-300",
                        ...
                        div {
                            ...
                            p { class: "ml-4", "Attach the vector to a node: Document, User, Product, Concept, etc." }
                        }
                        div {
                    ...
                    h4 { class: "text-lg font-semibold text-white mt-6 mb-2", "4. Why This Combination Is Powerful" }
                    div { class: "space-y-2 text-sm text-gray-300",
                        p { strong { "A. Semantic search" } " — ONNX generates embeddings → Neo4j finds similar nodes." }
                        p { strong { "B. Knowledge graph + embeddings" } " — Combine symbolic relationships (edges) with semantic similarity (vectors) for hybrid reasoning." }
                        p { strong { "C. Recommendation systems" } " — User embedding → find similar users or items in Neo4j." }
                        p { strong { "D. RAG (Retrieval-Augmented Generation)" } " — ONNX creates embeddings for chunks, Neo4j stores them, query for nearest neighbors, feed results into your LLM. A strong alternative to Pinecone, Weaviate, or FAISS." }
                    }

                    // 5. Architecture Diagram
                    h4 { class: "text-lg font-semibold text-white mt-6 mb-2", "5. Architecture Diagram" }
        ...
        if show_knowledge_graphs_modal() {
            div {
                ...
                div {
                    ...
                    // Introduction
                    p { class: "text-lg text-gray-200 mb-4",
                        "A " strong { "knowledge graph" } " is a data structure that uses "
                        strong { "nodes" } " to represent concepts and entities and "
                        strong { "relationships" } " to connect these nodes."
                    }
                    ...
                    p { class: "text-sm text-gray-300 mb-2",
                        "Concepts are " strong { "abstract categories or ideas" } ". They are not tied to a single, specific thing in the world."
                    }
                    ...
                    p { class: "text-sm text-gray-300 mt-3 mb-2",
                        "A concept represents a " strong { "type, class, or category" } ". In a knowledge graph, concepts often sit higher in the hierarchy and help organize meaning."
                    }
                    ...
                    p { class: "text-sm text-gray-300 mt-3",
                        "Concepts help the graph express " strong { "what something is" } "."
                    }

                    // Entities
                    h3 { class: "text-xl font-bold text-white mt-8 mb-3", "Entities" }
                    p { class: "text-sm text-gray-300 mb-2",
                        "Entities are " strong { "specific, individual things" } " that exist in the real world."
                    }
                    p { class: "text-sm text-gray-300 mb-2", "Examples:" }
                    ul { class: "space-y-1 text-sm text-gray-300 ml-4 list-disc",
                        li { "\"Pieter\"" }
                    ...
                    p { class: "text-sm text-gray-300 mt-3 mb-2",
                        "An entity represents a " strong { "unique instance" } " of a concept. For example:"
                    }
                    ul { class: "space-y-1 text-sm text-gray-300 ml-4 list-disc",
                        li { "\"Dog\" → concept" }
                    ...
                    p { class: "text-sm text-gray-300 mt-3",
                        "Entities help the graph express " strong { "which specific thing" } " we are talking about."
                    }

                    // How They Work Together
                    h3 { class: "text-xl font-bold text-white mt-8 mb-3", "How They Work Together in a Knowledge Graph" }
                    p { class: "text-sm text-gray-300 mb-2", "A simple structure might look like this:" }
                    ...
                    ul { class: "space-y-1 text-sm text-gray-300 ml-4 list-disc",
                        li { strong { "City" } " and " strong { "Programming language" } " are concepts" }
                        li { strong { "Paris" } ", " strong { "Eiffel Tower" } ", and " strong { "Python 3.12" } " are entities" }
                    }
                    div { class: "bg-gray-700 rounded p-4 my-4 border-l-4 border-blue-500",
                        p { class: "text-gray-200",
                            strong { "Concepts" } " give structure."
                            br {}
                            strong { "Entities" } " give concrete meaning."
                            br {}
                            strong { "Relationships" } " connect them into a navigable semantic network."
                        }
                    }

                    // How This Relates to Embeddings
                    h3 { class: "text-xl font-bold text-white mt-8 mb-3", "How This Relates to Embeddings" }
                    p { class: "text-sm text-gray-300 mb-2",
                        "Embeddings give you a vector representation: " strong { "v ∈ ℝⁿ" }
                    }
                    ...
                    p { class: "text-sm text-gray-300 mt-3 mb-2", "This is where things get interesting:" }
                    div { class: "space-y-3 text-sm text-gray-300",
                        div {
                            strong { "Concepts get concept embeddings" }
                            p { class: "ml-4", "These capture the general meaning of a category." }
                            p { class: "ml-4 text-gray-400", "Example: The embedding for \"City\" encodes the idea of cities in general." }
                        }
                        div {
                            strong { "Entities get entity embeddings" }
                            p { class: "ml-4", "These capture the specific meaning of a particular instance." }
                            p { class: "ml-4 text-gray-400", "Example: The embedding for \"Paris\" encodes the specific city, not the general idea of cities." }
                        }
                    }
                    p { class: "text-sm text-gray-300 mt-3",
                    ...
                    p { class: "text-sm text-gray-300 mt-2 mb-1", "It outputs: a vector (v ∈ ℝⁿ)" }
        ...
        if show_io_uring_modal() {
            div {
                ...
                div {
                    class: "px-4 py-4 w-full pb-20",

                    // Close button
                    div {
                        class: "flex justify-between items-start mb-2",
                        h2 { class: "text-xl font-bold text-white", "io_uring: A Unified Async I/O API for Linux" }
                        button {
                            class: "text-white text-xl hover:text-gray-300",
                    ...
                    div { class: "grid grid-cols-1 lg:grid-cols-3 gap-4 mb-4",
                        ...
                        div { class: "bg-gray-900 rounded p-3",
                            ...
                            p { class: "text-xs text-gray-300 mb-2", "Linux kernel interface (5.1+) for async I/O:" }
                            ...
                            p { class: "text-xs text-yellow-300 mt-2", "⭐ File I/O (doc ingestion, index loading) is where io_uring helps most!" }
                        }
...
Key: Shared rings = no copy, minimal syscalls"
                        ...
                        div { class: "bg-gray-900 rounded p-3",
                            ...
                            table { class: "table table-xs text-gray-300 w-full",
                                ...
                                tbody {
                                    tr { td { "Syscalls/IO" } td { "1-2" } td { class: "text-green-400", "0-1" } }
                                    tr { td { "File async" } td { class: "text-red-400", "Fake" } td { class: "text-green-400", "True" } }
                                    tr { td { "Batching" } td { class: "text-red-400", "No" } td { class: "text-green-400", "Yes" } }
                                    tr { td { "Zero-copy" } td { class: "text-red-400", "Limited" } td { class: "text-green-400", "Yes" } }
                                    tr { td { "CPU" } td { "Higher" } td { class: "text-green-400", "30-50% lower" } }
                                }
                            }
                            p { class: "text-xs text-gray-400 mt-2", "Benchmark: epoll ~400k ops/s → io_uring ~800k ops/s (2x)" }
                        }
                    }
                    ...
                    div { class: "grid grid-cols-1 lg:grid-cols-3 gap-4 mb-4",
                        ...
                        div { class: "bg-gray-900 rounded p-3",
                            ...
                            div { class: "text-[10px] text-gray-300 space-y-0.5",
                                p { span { class: "text-gray-400", "File: " } "Read, Write, Fsync, Fallocate" }
                                p { span { class: "text-gray-400", "Socket: " } "Accept, Connect, Recv, Send" }
                                p { span { class: "text-gray-400", "Advanced: " } "SendZc, RecvMulti" }
                                p { span { class: "text-gray-400", "Timers: " } "Timeout, LinkTimeout" }
                                p { span { class: "text-gray-400", "Polling: " } "PollAdd, PollRemove" }
                                p { span { class: "text-gray-400", "Files: " } "Open, Close, Stat, Rename" }
                                p { span { class: "text-gray-400", "Misc: " } "Cancel, Splice, Shutdown" }
                            }
                        ...
                        div { class: "bg-gray-900 rounded p-3",
                            ...
                            div { class: "text-[10px] text-gray-300 space-y-0.5",
                                p { span { class: "font-mono text-blue-300", "io-uring" } " - Low-level bindings" }
                                p { span { class: "font-mono text-blue-300", "tokio-uring" } " - Tokio + io_uring" }
                                p { span { class: "font-mono text-blue-300", "glommio" } " - Thread-per-core" }
                                p { span { class: "font-mono text-blue-300", "monoio" } " - High-perf runtime" }
                                p { span { class: "font-mono text-blue-300", "nuclei" } " - Proactive I/O" }
                            }
...
async fn main() {{
  ...
  let (res, buf) = file.read_at(buf, 0).await;
                        ...
                        div { class: "bg-gray-900 rounded p-3",
                            ...
                            div { class: "text-[10px] text-gray-300 space-y-0.5",
                                p { span { class: "text-gray-400", "Vector index: " } "True async file reads" }
                                p { span { class: "text-gray-400", "Ingestion: " } "Batch file operations" }
                                p { span { class: "text-gray-400", "HTTP API: " } "Lower latency sockets" }
                                p { span { class: "text-gray-400", "Redis L3: " } "Faster network I/O" }
                                p { span { class: "text-gray-400", "Logging: " } "Efficient file writes" }
                            }
                            p { class: "text-[10px] text-green-400 mt-2", "✅ Hybrid mode: Actix+Tokio for HTTP, io_uring for file I/O (vectors, cache). Enable with --features io_uring" }
                        }
                    }
        ...
        if show_bias_modal() {
            div {
                ...
                div {
                    ...
                    p { class: "text-lg text-gray-200 mb-6", "The word 'bias' means completely different things in ML depending on context." }

                    // Social/Cognitive Bias
                    h3 { class: "text-xl font-bold text-white mt-6 mb-3", "1. Social/Cognitive Bias (Training Data, Behavior)" }
                    div { class: "bg-red-900/30 border border-red-700 rounded p-4 mb-4",
                        p { class: "text-sm text-gray-200 mb-3", "What people usually mean in public discourse—the model favoring certain viewpoints, perpetuating stereotypes, having political leanings, etc." }
                    ...
                    // Mathematical Bias
                    h3 { class: "text-xl font-bold text-white mt-6 mb-3", "2. Mathematical Bias (Weight Parameter)" }
                    div { class: "bg-blue-900/30 border border-blue-700 rounded p-4 mb-4",
                        p { class: "text-sm text-gray-200 mb-3", "ML papers and code are full of \"bias terms\", \"bias vectors\", \"bias parameters\". This is a completely unrelated concept." }
                        p { class: "text-sm text-gray-300 mb-2", "In a neural network: y = σ(W·x + b)" }
                        p { class: "text-sm text-gray-300", "The 'b' is the bias—a learnable offset that shifts the activation function. It allows neurons to activate even when inputs are zero." }
                    }

                    // The Naming Problem
                    h3 { class: "text-xl font-bold text-white mt-6 mb-3", "The Naming Problem" }
                    div { class: "bg-gray-900 rounded p-4",
                        p { class: "text-sm text-gray-300 mb-3", "These are completely unrelated concepts that unfortunately share a name." }
                        p { class: "text-sm text-gray-300 mb-3", "The mathematical term predates the fairness discussion by decades—it comes from statistics (as in \"bias-variance tradeoff\")." }
                        p { class: "text-sm text-yellow-300", "Some people have suggested renaming the mathematical one to \"offset\" in educational materials, but the terminology is deeply entrenched." }
                    }
                    ...
                    table { class: "table table-sm w-full text-gray-300",
                        ...
                        tbody {
                            tr { td { "Meaning" } td { "Prejudice, unfairness" } td { "Numeric offset" } }
                            tr { td { "Source" } td { "Training data, RLHF" } td { "Learned parameter" } }
                            tr { td { "Fix" } td { "Better data, alignment" } td { "N/A (it's intentional)" } }
                            tr { td { "In code" } td { "Not visible" } td { "model.bias, b tensor" } }
                            tr { td { "Origin" } td { "Fairness research" } td { "Statistics (1900s)" } }
                        }
                    }
                    ...
                    h3 { class: "text-xl font-bold text-white mt-6 mb-3", "Summary" }
                    div { class: "bg-gray-700 rounded p-4 text-sm text-gray-200",
                        p { class: "mb-2", "• When someone says \"the model is biased\" → they mean social/cognitive bias (prejudice)" }
                        p { class: "mb-2", "• When code says \"bias=True\" or \"self.bias\" → it means the mathematical offset parameter" }
        ...
        if show_threads_modal() {
            div {
                ...
                div {
                    class: "p-6 max-w-5xl mx-auto pb-20",

                    // Close button
                    div {
                        class: "flex justify-between items-start mb-4",
                        h2 { class: "text-2xl font-bold text-white", "Threads in Rust: Tokio, Rayon & spawn_blocking" }
                        button {
                            class: "text-white text-xl hover:text-gray-300",
                    ...
                    div { class: "bg-gray-900 rounded p-4 mb-6",
                        div { class: "grid grid-cols-1 lg:grid-cols-2 gap-6",
                            // Left: Definition
                            div {
                                p { class: "text-sm text-gray-200 mb-3", "A thread is the smallest unit of execution that a CPU can schedule and run. It represents a single sequence of instructions inside a program." }
                                ul { class: "text-xs text-gray-300 list-disc ml-4 space-y-1",
                                    ...
                                    li { "Opening an app creates at least one thread; more appear as tasks run concurrently" }
                                    li { "Modern systems support multithreading for better responsiveness and performance" }
                                }
                            }
                            // Right: Why Threads Matter
                            div {
                                h4 { class: "text-sm font-bold text-white mb-2", "🧠 Why Threads Matter" }
                                p { class: "text-xs text-gray-300 mb-2", "Threads allow programs to:" }
                                ul { class: "text-xs text-gray-300 list-disc ml-4 space-y-1",
                                    li { "Perform multiple tasks at once (UI stays responsive while work happens in background)" }
                    ...
                    h3 { class: "text-xl font-bold text-white mt-6 mb-3", "🧵 Async: A Thread-Saving Mechanism" }
                    div { class: "bg-gray-900 rounded p-4 mb-6",
                        div { class: "grid grid-cols-1 lg:grid-cols-2 gap-6",
                            // Left: Why Async Exists
                            div {
                                p { class: "text-sm text-yellow-300 font-semibold mb-2", "Threads are powerful but expensive" }
                                ...
                                p { class: "text-sm text-blue-300 font-semibold mb-2", "I/O-bound threads are wasteful" }
                                p { class: "text-xs text-gray-300", "A thread waiting on a socket, file, timer, or DB call is mostly idle. Async solves: how to handle millions of I/O ops without millions of threads?" }
                            }
                            // Right: What Async Is
                            div {
                                p { class: "text-sm text-green-300 font-semibold mb-2", "Async tasks are NOT threads" }
                                ul { class: "text-xs text-gray-300 list-disc ml-4 space-y-1 mb-3",
                                    li { "Not scheduled by the OS" }
                                    li { "Not running in parallel" }
                                    li { "Not preemptive" }
                                }
                                p { class: "text-xs text-gray-300 mb-2", "An async task is a tiny state machine, polled by an executor, suspended when waiting, resumed when ready." }
                        ...
                        div { class: "mt-4 pt-4 border-t border-gray-700",
                            div { class: "grid grid-cols-1 md:grid-cols-2 gap-4 text-xs",
                                div {
                                    p { class: "text-purple-300 font-semibold mb-1", "Use THREADS when:" }
                                    p { class: "text-gray-300", "CPU-bound, true parallelism, heavy computation, independent stacks" }
                                }
                                div {
                                    p { class: "text-blue-300 font-semibold mb-1", "Use ASYNC when:" }
                                    p { class: "text-gray-300", "I/O-bound, 10k-1M connections, minimal memory, cooperative scheduling" }
                                }
                            }
                        }
                    }
                    ...
                    h3 { class: "text-xl font-bold text-white mt-6 mb-3", "🦀 What Makes Rust Special" }
                    div { class: "bg-orange-900/20 border border-orange-700 rounded p-4 mb-6",
                        div { class: "grid grid-cols-1 lg:grid-cols-2 gap-6",
                            // Left: Ownership & Threads
                            div {
                                p { class: "text-sm text-orange-300 font-semibold mb-2", "Fearless Concurrency" }
                                p { class: "text-xs text-gray-300 mb-2", "Rust's ownership system prevents data races at compile time:" }
                                ul { class: "text-xs text-gray-300 list-disc ml-4 space-y-1",
                                    li { span { class: "text-green-300", "Send" } " – type can be transferred to another thread" }
                                    li { span { class: "text-green-300", "Sync" } " – type can be shared between threads" }
                                    li { "Compiler enforces these automatically" }
                                    li { "No runtime cost – all checked at compile time" }
                                }
                                p { class: "text-xs text-gray-400 mt-2", "Other languages: data races are runtime bugs. Rust: they don't compile." }
                            }
                            // Right: Why Rust Async is Different
                            div {
                                p { class: "text-sm text-orange-300 font-semibold mb-2", "Zero-Cost Async" }
                                p { class: "text-xs text-gray-300 mb-2", "Rust has no GC, no built-in runtime, no scheduler. So async must be:" }
                                ul { class: "text-xs text-gray-300 list-disc ml-4 space-y-1",
                                    li { span { class: "text-yellow-300", "Zero-cost" } " – no overhead vs hand-written state machines" }
                                    li { span { class: "text-yellow-300", "Explicit" } " – you choose the executor (Tokio, async-std)" }
                                    li { span { class: "text-yellow-300", "State-machine compiled" } " – async fn → enum at compile time" }
                                    li { span { class: "text-yellow-300", "No hidden allocations" } " – you control memory" }
                                }
                                p { class: "text-xs text-gray-400 mt-2", "Go/JS: runtime handles everything. Rust: you're in control." }
                            }
                        }
                        div { class: "mt-4 pt-3 border-t border-orange-700/50 text-xs text-center text-orange-200",
                            "Rust async is not a general concurrency model — it's a " span { class: "font-semibold", "thread-saving mechanism" } " for I/O workloads."
                        }
                    }
                    ...
                    div { class: "bg-gray-700 rounded p-4 mb-6",
                        p { class: "text-sm text-gray-200 mb-2", "Think of a " span { class: "text-blue-300 font-semibold", "process" } " as a workshop." }
                        p { class: "text-sm text-gray-200 mb-3", "A " span { class: "text-green-300 font-semibold", "thread" } " is a worker inside that workshop." }
                        ul { class: "text-xs text-gray-300 list-disc ml-4 space-y-1",
                    ...
                    div { class: "grid grid-cols-1 lg:grid-cols-3 gap-4 mb-4",
                        div { class: "bg-purple-900/30 border border-purple-700 rounded p-4",
                            ...
                            p { class: "text-xs text-gray-300 mb-2", "Created & scheduled by OS kernel. Each has own stack (1-8MB). Expensive (~10k cycles)." }
                            p { class: "text-xs text-gray-400", "Examples: std::thread, pthread, Rayon, spawn_blocking" }
                        }
                        div { class: "bg-green-900/30 border border-green-700 rounded p-4",
                            h4 { class: "font-bold text-green-300 mb-2", "Green Threads" }
                            p { class: "text-xs text-gray-300 mb-2", "Created by runtime, not OS. Very lightweight (~KB stack). Can have millions." }
                            p { class: "text-xs text-gray-400", "Examples: Go goroutines, Erlang processes" }
                        }
                        div { class: "bg-blue-900/30 border border-blue-700 rounded p-4",
                            h4 { class: "font-bold text-blue-300 mb-2", "Async Tasks" }
                            p { class: "text-xs text-gray-300 mb-2", "Not threads—" span { class: "text-white font-semibold", "state machines" } " that pause/resume. Multiplexed on few OS threads." }
                            p { class: "text-xs text-gray-400", "Examples: Tokio tasks, JS Promises, Python asyncio" }
                        }
                    }
                    ...
                    div { class: "bg-gray-900 rounded p-4 mb-4",
                        p { class: "text-sm text-gray-300 mb-3", "These roles can be filled by OS threads or green threads—the role is about what code they run:" }
                        div { class: "grid grid-cols-1 md:grid-cols-2 gap-2 text-xs text-gray-300",
                            div {
                                p { class: "mb-1", span { class: "text-blue-300 font-semibold", "Main thread" } " – entry point, coordinator or event loop" }
                                p { class: "mb-1", span { class: "text-blue-300 font-semibold", "Worker threads" } " – execute tasks from a queue" }
                                p { class: "mb-1", span { class: "text-blue-300 font-semibold", "I/O threads" } " – handle I/O polling/completion" }
                                p { class: "mb-1", span { class: "text-blue-300 font-semibold", "Blocking threads" } " – isolated pool for sync/blocking work" }
                                p { class: "mb-1", span { class: "text-blue-300 font-semibold", "Timer thread" } " – manages scheduled/delayed tasks" }
                                p { class: "mb-1", span { class: "text-blue-300 font-semibold", "Signal handler" } " – catches OS signals (SIGTERM, etc.)" }
                            }
                            div {
                                p { class: "mb-1", span { class: "text-blue-300 font-semibold", "GUI/UI thread" } " – owns render loop, event processing" }
                                p { class: "mb-1", span { class: "text-blue-300 font-semibold", "GC thread" } " – garbage collection (Java, Go, etc.)" }
                                p { class: "mb-1", span { class: "text-blue-300 font-semibold", "Finalizer thread" } " – runs destructors/cleanup (JVM)" }
                                p { class: "mb-1", span { class: "text-blue-300 font-semibold", "Watchdog thread" } " – monitors health, triggers recovery" }
                                p { class: "mb-1", span { class: "text-blue-300 font-semibold", "Logger thread" } " – async log writing to avoid blocking" }
                                p { class: "mb-1", span { class: "text-blue-300 font-semibold", "Daemon threads" } " – periodic tasks, housekeeping" }
                            }
                        }
                        p { class: "text-xs text-gray-400 mt-3", "Not every program has all of these. A simple CLI might just have main. A complex server might have several." }
                    }
                    ...
                    div { class: "grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4",
                        div { class: "bg-blue-900/30 border border-blue-700 rounded p-4",
                            ...
                            p { class: "text-sm text-gray-300 mb-2", "CPU sits idle while waiting for external resources." }
                        ...
                        div { class: "bg-green-900/30 border border-green-700 rounded p-4",
                            ...
                            p { class: "text-sm text-gray-300 mb-2", "CPU is actively working, no waiting." }
                            ul { class: "text-sm text-gray-300 list-disc ml-4 space-y-1",
                            ...
                            p { class: "text-xs text-green-300 mt-2", "→ Use Rayon or spawn_blocking" }
                        }
                    }
                    ...
                    div { class: "bg-gray-900 rounded p-4 mb-4",
                        p { class: "text-sm text-gray-300 mb-2", "Tokio handles thousands of concurrent I/O operations with few threads." }
...
async fn handle_request() {{
    ...
    // Tokio juggles thousands of these
                        ...
                        p { class: "text-xs text-gray-400 mt-2", "Your AG project: HTTP handlers, Redis cache, database queries" }
                    }

                    // Rayon
                    h3 { class: "text-xl font-bold text-white mt-6 mb-3", "Rayon: Parallel CPU Work" }
                    div { class: "bg-gray-900 rounded p-4 mb-4",
                        p { class: "text-sm text-gray-300 mb-2", "Rayon splits CPU work across all cores automatically." }
                        pre { class: "text-xs text-green-300 font-mono bg-gray-950 p-3 rounded mt-2",
"use rayon::prelude::*;
...
let embeddings: Vec<_> = chunks
    ...
    .collect();"
                        ...
                        p { class: "text-xs text-gray-400 mt-2", "Your AG project: retriever.rs, batch.rs, product_quantization.rs" }
                    }

                    // spawn_blocking
                    h3 { class: "text-xl font-bold text-white mt-6 mb-3", "spawn_blocking: CPU Work in Async Context" }
                    div { class: "bg-gray-900 rounded p-4 mb-4",
                        p { class: "text-sm text-gray-300 mb-2", "When you need to do CPU work inside an async function, use spawn_blocking to avoid blocking the Tokio runtime." }
                        pre { class: "text-xs text-green-300 font-mono bg-gray-950 p-3 rounded mt-2",
"// In embedder.rs
let embedding = task::spawn_blocking(move || {{
    runtime.embed_owned(text)  // CPU-heavy, runs on blocking thread
                        ...
                        p { class: "text-xs text-yellow-300 mt-2", "⚠️ Never do heavy CPU work directly in async fn - it blocks other requests!" }
                    }
                    ...
                    table { class: "table table-sm w-full text-gray-300 mb-4",
                        ...
                        tbody {
                            tr { td { "HTTP request" } td { class: "text-blue-300", "tokio::spawn" } td { "I/O wait" } }
                            tr { td { "Database query" } td { class: "text-blue-300", "async/await" } td { "I/O wait" } }
                            tr { td { "Batch embeddings" } td { class: "text-green-300", "rayon par_iter" } td { "CPU parallel" } }
                            tr { td { "Single embedding" } td { class: "text-yellow-300", "spawn_blocking" } td { "CPU in async" } }
                            tr { td { "Vector search" } td { class: "text-green-300", "rayon" } td { "CPU parallel" } }
                            tr { td { "File read" } td { class: "text-blue-300", "tokio::fs" } td { "I/O wait" } }
                        }
                    }
                    ...
                    div { class: "bg-gray-700 rounded p-4 text-sm text-gray-200",
                        p { class: "mb-2", "✅ Tokio 1.47 with full features - HTTP, Redis, async tasks" }
                        p { class: "mb-2", "✅ Rayon 1.10 - retriever.rs, batch.rs, product_quantization.rs" }
